...
> = {
  MENSTRUAL: {
    ...
    scientificContext: 'Inicio del ciclo biológico con reajuste natural del cuerpo.',
    practicalConsideration:
      'Durante esta etapa ocurren cambios naturales en el cuerpo. Algunas personas pueden sentir mayor cansancio físico o necesidad de tranquilidad.',
    dailyActionIdea: 'En lugar de intentar arreglarlo todo, empieza preguntando cómo está.',
    microGesture: '¿Cómo estás hoy? Si necesitas descansar o estar tranquila, cuenta conmigo.',
    whatToAvoid: 'No interpretes su respuesta antes de escucharla ni tomes la necesidad de silencio como distancia personal.',
  },
  FOLLICULAR: {
    name: 'FASE FOLICULAR',
    dayRangeText: 'Días 6 a 13 aprox.',
    scientificContext: 'Etapa de recuperación y mayor energía natural del ciclo.',
    practicalConsideration:
      'Durante esta etapa ocurren cambios naturales en el cuerpo. Suele ser un momento propicio para conversar, compartir planes y coordinar con calma.',
    dailyActionIdea: 'Buen momento para conversar sobre iniciativas compartidas con escucha activa.',
    microGesture: '¿Qué te gustaría hacer hoy o durante el fin de semana?',
    whatToAvoid: 'No des por sentado que siempre habrá disponibilidad total; cada día tiene sus propios matices.',
  },
  OVULATORY: {
    name: 'FASE OVULATORIA',
    dayRangeText: 'Días 14 a 16 aprox.',
    scientificContext: 'Etapa intermedia del ciclo con mayor apertura comunicativa y social.',
    practicalConsideration:
      'Durante esta etapa ocurren cambios naturales en el cuerpo. Puede existir mayor apertura para conectar y conversar con fluidez.',
    ...
    whatToAvoid: 'No generes expectativas rígidas; el contexto orienta, la conversación confirma.',
  },
  LUTEAL: {
    name: 'FASE LÚTEA',
    dayRangeText: 'Días 17 a 28 aprox.',
    scientificContext: 'Segunda mitad del ciclo donde el cuerpo se prepara para un nuevo ciclo.',
    practicalConsideration:
      'Durante esta etapa ocurren cambios naturales en el cuerpo. Algunas personas pueden experimentar mayor sensibilidad a la sobrecarga o al cansancio acumulado.',
    dailyActionIdea: 'Antes de reaccionar a un cambio de tono o cansancio, haz una pausa y no lo tomes como algo personal.',
    microGesture: 'Noto que ha sido un día largo. ¿Quieres que preparemos algo tranquilos o prefieres un rato para ti?',
    whatToAvoid: 'No interpretes su respuesta antes de escucharla ni conviertas el cansancio en una discusión sobre la relación.',
  },
};
